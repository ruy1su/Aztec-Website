...
var ontology_map = require('../controllers/ontology-controller');
...
ToolInfoViewModel.prototype._load = function (self, callback) {
    ...
    cont.run = function() {
        ...
        BD2K.solr.search({"id": self.request}, function (obj) {
            ...
            //Now modify description to highlight the ontologies
            if(self.resource !== undefined)
                self.resource["description"] = ontology_map.get_description(self.resource["description"]);
            self.onLoad();
        });
